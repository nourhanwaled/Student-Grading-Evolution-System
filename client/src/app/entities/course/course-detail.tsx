    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseDetailsHeading">
          <Translate contentKey="studentGradingEvalutionSystemApp.course.detail.title">Course</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="studentGradingEvalutionSystemApp.course.name">Name</Translate>
            </span>
          </dt>
          <dd>{courseEntity.name}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="studentGradingEvalutionSystemApp.course.description">Description</Translate>
            </span>
          </dt>
