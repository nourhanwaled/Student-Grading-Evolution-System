...
export const CourseDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="studentGradingEvalutionSystemApp.course.delete.question">
        <Translate contentKey="studentGradingEvalutionSystemApp.course.delete.question" interpolate={{ id: courseEntity.id }}>
