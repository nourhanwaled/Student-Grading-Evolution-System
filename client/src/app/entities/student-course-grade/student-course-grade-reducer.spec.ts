...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './student-course-grade.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTCOURSEGRADE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTCOURSEGRADE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTCOURSEGRADE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STUDENTCOURSEGRADE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTCOURSEGRADE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTCOURSEGRADE actions', async () => {
      const arg = 42666;
