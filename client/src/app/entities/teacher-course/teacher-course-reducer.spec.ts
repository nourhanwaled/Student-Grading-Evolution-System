...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEACHERCOURSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TEACHERCOURSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TEACHERCOURSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TEACHERCOURSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TEACHERCOURSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TEACHERCOURSE actions', async () => {
      const arg = 42666;
