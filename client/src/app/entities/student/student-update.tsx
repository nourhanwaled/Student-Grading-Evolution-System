  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="studentGradingEvalutionSystemApp.student.home.createOrEditLabel" data-cy="StudentCreateUpdateHeading">
            <Translate contentKey="studentGradingEvalutionSystemApp.student.home.createOrEditLabel">Create or edit a Student</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('studentGradingEvalutionSystemApp.student.user')}
                type="select"
              >
                <option value="" key="0" />
                {users
