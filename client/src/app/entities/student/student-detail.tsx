    ...
    <Row>
      <Col md="8">
        <h2 data-cy="studentDetailsHeading">
          <Translate contentKey="studentGradingEvalutionSystemApp.student.detail.title">Student</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="studentGradingEvalutionSystemApp.student.user">User</Translate>
          </dt>
