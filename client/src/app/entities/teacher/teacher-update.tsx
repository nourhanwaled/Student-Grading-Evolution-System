  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="studentGradingEvalutionSystemApp.teacher.home.createOrEditLabel" data-cy="TeacherCreateUpdateHeading">
            <Translate contentKey="studentGradingEvalutionSystemApp.teacher.home.createOrEditLabel">Create or edit a Teacher</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('studentGradingEvalutionSystemApp.teacher.user')}
                type="select"
              >
                <option value="" key="0" />
                {users
