...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTCOURSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTCOURSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTCOURSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STUDENTCOURSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTCOURSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTCOURSE actions', async () => {
      const arg = 42666;
